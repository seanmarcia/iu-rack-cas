...
class Rack::CAS
  ...
  def call(env)
    ...
    if cas_request.ticket_validation?
      ...
      begin
        user = get_user(request.url, cas_request.ticket)
      ...
      store_session request, user, cas_request.ticket
